...
g++ -Wall -DENABLE_CHECKPOINTING -DVERBOSE -DENABLE_COLOR -DFALSE_ONLY -O3 -msse3 -funroll-loops -ftree-vectorize subset_sum_main.cpp ../common/output.cpp -o ../bin/subset_sum
